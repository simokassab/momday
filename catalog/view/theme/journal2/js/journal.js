...
Journal.gridView = function () {
    ...
    $('.celebrity-store-button-identifier').removeClass('button-celebrity-store-list');

    $('.celebrity-cart-button-identifier').addClass('grid-button-cart-celebrity');
    $('.celebrity-cart-text-identifier').addClass('grid-button-cart-text-celebrity');

    $('.celebrity-store-button-text-identifier').addClass('button-celebrity-store-grid-text');
    $('.celebrity-store-button-identifier').addClass('button-celebrity-store-grid');
...
Journal.listView = function () {
    ...
    $('.celebrity-store-button-identifier').removeClass('button-celebrity-store-grid');
    $('.celebrity-store-button-text-identifier').removeClass('button-celebrity-store-grid-text');

    $('.celebrity-cart-button-identifier').removeClass('grid-button-cart-celebrity');
    $('.celebrity-cart-text-identifier').removeClass('grid-button-cart-text-celebrity');

    $('.celebrity-store-button-identifier').addClass('button-celebrity-store-list');
