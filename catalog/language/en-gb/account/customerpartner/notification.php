...
$_['text_order_add']	                = 'New order: <a href="index.php?route=account/customerpartner/orderinfo&order_id=%s" target="_blank">#%s</a> has been placed by <b>%s</b> <br/> <b>%s ago</b>';
...
$_['text_product_stock']	            = '<a href="index.php?route=product/product&product_id=%s" target="_blank"><b>%s</b></a> out of stock - <b>%s ago</b>';
...
$_['text_order_status']	              = 'Order: <a href="index.php?route=account/customerpartner/orderinfo&order_id=%s" target="_blank">#%s</a> status has been changed to <b>%s</b> <br/> <b>%s ago</b>';
