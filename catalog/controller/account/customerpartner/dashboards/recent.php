	...
	public function index() {		
		...
		foreach ($results as $result) {
			...
			$data['orders'][] = array(
				...
				'view'       => $this->url->link('account/customerpartner/orderinfo&order_id=' . $result['order_id'], '' ,true),
			);
		}
						
	  return ($this->load->view('account/customerpartner/dashboards/recent' , $data));
	}
}
