...
class ControllerAccountCustomerpartnerOrderlist extends Controller {
	...
	public function index() {
		...
		$this->data['sort_order'] = $this->url->link('account/customerpartner/orderlist', '' . '&sort=o.order_id' . $url, true);
		$this->data['sort_name'] = $this->url->link('account/customerpartner/orderlist', '' . '&sort=o.firstname' . $url, true);
		$this->data['sort_status'] = $this->url->link('account/customerpartner/orderlist', '' . '&sort=os.name' . $url, true);
