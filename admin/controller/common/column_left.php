...
//            $momday_blog = array();
//
//            if ($this->user->hasPermission('access', 'momday/add_blog_post')) {
//                $momday_blog[] = array(
//                    'name'     => $this->language->get('text_add_blog_post'),
//                    'href'     => $this->url->link('momday/add_blog_post', 'user_token=' . $this->session->data['user_token'], true),
//                    'children' => array()
//                );
//            }
//
//            if ($this->user->hasPermission('access', 'momday/view_blog_posts')) {
//                $momday_blog[] = array(
//                    'name'	   => $this->language->get('text_view_blog_posts'),
//                    'href'     => $this->url->link('momday/view_blog_posts', 'user_token=' . $this->session->data['user_token'], true),
//                    'children' => array()
//                );
//            }
//
//            if ($momday_blog) {
//                $catalog[] = array(
//                    'name'	   => $this->language->get('text_momday_blog'),
//                    'href'     => '',
//                    'children' => $momday_blog
//                );
//            }


            $momday = $this->load->controller('extension/module/momday/adminmenu');

            if ($momday) {
//                if ($this->user->hasPermission('access', 'momday')) {
//                 {
                    $data['menus'][] = array(
                        'id' => 'menu-momday',
                        'icon' => 'fa-users',
                        'name' => $this->language->get('text_momday'),
                        'href' => '',
                        'children' => $momday
                    );
//                }
