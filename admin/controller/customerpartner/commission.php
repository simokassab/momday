...
class ControllerCustomerpartnerCommission extends Controller {
	...
	private $data = array();
  	...
  	public function category() {
		...
		foreach ($filter_array as $unsetKey => $key) {
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('customerpartner/commission', 'user_token=' . $this->session->data['user_token']. $url, true),
      		'separator' => ' :: '
   		);

		$data['delete'] = $this->url->link('customerpartner/commission/delete', 'user_token=' . $this->session->data['user_token'] , true);
		$data['insert'] = $this->url->link('customerpartner/commission/addcategory', 'user_token=' . $this->session->data['user_token'] , true);
	    ...
	    foreach ($results as $result) {
	      	...
	      	$data['commission'][] = array(
				...
				'action' => $this->url->link('customerpartner/commission/addcategory&id='.$result['id'],'user_token='.$this->session->data['user_token'], true),
			);
		...
		$data['sort_name'] = $this->url->link('customerpartner/commission', 'user_token=' . $this->session->data['user_token'] . '&sort=cd.name' . $url, true);
		$data['sort_id'] = $this->url->link('customerpartner/commission', 'user_token=' . $this->session->data['user_token'] . '&sort=cc.id' . $url, true);
		...
		$pagination->url = $this->url->link('customerpartner/commission', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('customerpartner/commission_category',$data));
  	...
  	public function addcategory() {
    	...
    	$data['cancel'] = $this->url->link('customerpartner/commission', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['save'] = $this->url->link('customerpartner/commission/categorySave', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$this->response->setOutput($this->load->view('customerpartner/commission_category_form',$data));
	}
	...
	public function categorySave() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if(!isset($this->error['warning'])){
				...
				$this->response->redirect($this->url->link('customerpartner/commission', 'user_token=' . $this->session->data['user_token'], true));
			}
		}
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validate()) {
			...
			$this->response->redirect($this->url->link('customerpartner/commission', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
  	...
  	public function manual() {
		...
		foreach ($filter_array as $unsetKey => $key) {
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
       		'text'      => $this->language->get('heading_title'),
			'href'      => $this->url->link('customerpartner/commission/manual', 'user_token=' . $this->session->data['user_token']. $url, true),
      		'separator' => ' :: '
   		);

		$data['delete'] = $this->url->link('customerpartner/commission/deleteManual', 'user_token=' . $this->session->data['user_token'] , true);
		$data['insert'] = $this->url->link('customerpartner/commission/addManual', 'user_token=' . $this->session->data['user_token'] , true);
	    ...
	    foreach ($results as $result) {
	      	...
	      	$data['commission'][] = array(
				...
				'name' => $result['name'],
				'value' => '<span class="fixed">'.$data['entry_fixed'].'</span> - ' .$result['fixed'] .' + <span class="percentage">'.$data['entry_percentage'].'</span> - ' .$result['percentage'].' %',
				'action' => $this->url->link('customerpartner/commission/addManual&id='.$result['id'],'user_token='.$this->session->data['user_token'], true),
			);
		...
		$data['sort_name'] = $this->url->link('customerpartner/commission/manual', 'user_token=' . $this->session->data['user_token'] . '&sort=cd.name' . $url, true);
		$data['sort_id'] = $this->url->link('customerpartner/commission/manual', 'user_token=' . $this->session->data['user_token'] . '&sort=cc.id' . $url, true);
		...
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->text = $this->language->get('text_pagination');
		$pagination->url = $this->url->link('customerpartner/commission/manual', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$this->template = 'customerpartner/commission_manual';
  	...
  	public function addManual() {
    	...
    	$data['cancel'] = $this->url->link('customerpartner/commission/manual', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['save'] = $this->url->link('customerpartner/commission/manualSave', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$this->template = 'customerpartner/commission_manaul_form';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function manualSave() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if(!isset($this->error['warning'])){
				...
				$this->redirect($this->url->link('customerpartner/commission/manual', 'user_token=' . $this->session->data['user_token'], true));
			}
		}
	...
	public function deleteManual() {
		...
		if (isset($this->request->post['selected']) && $this->validate()) {
			...
			$this->redirect($this->url->link('customerpartner/commission/manual', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
