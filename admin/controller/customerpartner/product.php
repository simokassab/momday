  	...
  	private function getList() {
		...
		$data['base_url'] = str_replace('/admin/', '', $data['base_url']);
  		...
  		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('customerpartner/product', 'user_token=' . $this->session->data['user_token'] . $url, true),
      		'separator' => ' :: '
   		);
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('catalog/product/edit', 'user_token=' . $this->session->data['user_token'] . '&mpcheck=1&product_id=' . $product_id . $url, true)
			);
		...
		$data['sort_name'] = $this->url->link('customerpartner/product', 'user_token=' . $this->session->data['user_token'] . '&sort=pd.name' . $url, true);
		$data['sort_seller_name'] = $this->url->link('customerpartner/product', 'user_token=' . $this->session->data['user_token'] . '&sort=c.customer_id' . $url, true);
		$data['sort_model'] = $this->url->link('customerpartner/product', 'user_token=' . $this->session->data['user_token'] . '&sort=p.model' . $url, true);
		$data['sort_price'] = $this->url->link('customerpartner/product', 'user_token=' . $this->session->data['user_token'] . '&sort=p.price' . $url, true);
		$data['sort_quantity'] = $this->url->link('customerpartner/product', 'user_token=' . $this->session->data['user_token'] . '&sort=p.quantity' . $url, true);
		$data['sort_status'] = $this->url->link('customerpartner/product', 'user_token=' . $this->session->data['user_token'] . '&sort=p.product_id' . $url, true);
		$data['sort_order'] = $this->url->link('customerpartner/product', 'user_token=' . $this->session->data['user_token'] . '&sort=p.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('customerpartner/product', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('customerpartner/product_list',$data));
