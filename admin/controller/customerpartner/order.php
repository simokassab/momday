...
class ControllerCustomerpartnerOrder extends Controller {
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('customerpartner/order', 'user_token=' . $this->session->data['user_token'] . $url, true)
		);
		...
		foreach ($results as $result) {
			$data['orders'][] = array(
				...
				'view'          => $this->url->link('customerpartner/order/info', 'user_token=' . $this->session->data['user_token'] . '&seller_id='.$result['seller_id'].'&order_id=' . $result['order_id'] . $url, true),
				'edit'          => $this->url->link('customerpartner/order/edit', 'user_token=' . $this->session->data['user_token'] . '&order_id=' . $result['order_id'] . $url, true),
				'seller_access' => $result['seller_access'],
				'access'        => $this->url->link('customerpartner/order/access', 'user_token=' . $this->session->data['user_token']. '&seller_access=' . $result['seller_access'] . $url, true),
			);
		}

		$data['access'] = $this->url->link('customerpartner/order/access', 'user_token=' . $this->session->data['user_token'] . '&seller_access=0' . $url, true);
		...
		$data['sort_order'] = $this->url->link('customerpartner/order', 'user_token=' . $this->session->data['user_token'] . '&sort=o.order_id' . $url, true);
		$data['sort_customer'] = $this->url->link('customerpartner/order', 'user_token=' . $this->session->data['user_token'] . '&sort=customer' . $url, true);
		$data['sort_status'] = $this->url->link('customerpartner/order', 'user_token=' . $this->session->data['user_token'] . '&sort=status' . $url, true);
		$data['sort_access'] = $this->url->link('customerpartner/order', 'user_token=' . $this->session->data['user_token'] . '&sort=status' . $url, true);
		$data['sort_total'] = $this->url->link('customerpartner/order', 'user_token=' . $this->session->data['user_token'] . '&sort=o.total' . $url, true);
		$data['sort_date_added'] = $this->url->link('customerpartner/order', 'user_token=' . $this->session->data['user_token'] . '&sort=o.date_added' . $url, true);
		$data['sort_date_modified'] = $this->url->link('customerpartner/order', 'user_token=' . $this->session->data['user_token'] . '&sort=o.date_modified' . $url, true);
		...
		$pagination->url = $this->url->link('customerpartner/order', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('customerpartner/order_list', $data));
	}
	...
	public function info() {
		...
		if ($order_info) {
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
				...
				if($order_id){
					...
					if (isset($this->request->get['seller_id']) && $this->request->get['seller_id']) {
					  $this->response->redirect($this->url->link('customerpartner/order/info&seller_id='.(int)$this->request->get['seller_id'].'&order_id='.$order_id,'user_token=' . $this->session->data['user_token'], true));
					} else {
			...
			$data['cancel'] = $this->url->link('customerpartner/order', 'user_token=' . $this->session->data['user_token'] . $url, true);
			...
			$results = $this->model_customerpartner_order->getOrderHistories($order_id);
      		...
      		$data['user_token'] = $this->session->data['user_token'];
					...
					if (isset($this->request->get['seller_id']) && $this->request->get['seller_id']) {
					  $data['action'] = $this->url->link('customerpartner/order/info&seller_id='.(int)$this->request->get['seller_id'].'&order_id='.$order_id,'user_token=' . $this->session->data['user_token'], true);
					} else {
					  $data['action'] = $this->url->link('customerpartner/order/info&order_id='.$order_id,'user_token=' . $this->session->data['user_token'], true);
					}
			...
			$this->response->setOutput($this->load->view('customerpartner/order_info', $data));
	...
	private function changeOrderStatus($get,$post,$products,$marketplace_cancel_order_status,$seller_change_order_status_name){
  	...
  	public function access(){
		...
		if (isset($this->request->post['selected']) && $this->validate()) {
			...
			$this->response->redirect($this->url->link('customerpartner/order', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
