...
class ControllerCatalogProduct extends Controller {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            elseif (isset($this->request->get['momday'])) {
                $this->response->redirect($this->url->link('momday/momday_products', 'user_token=' . $this->session->data['user_token'] . $url, true));
            }
	...
	protected function getForm() {
        ...
        elseif (isset($this->request->get['momday'])) {
            if (!isset($this->request->get['product_id'])) {
                $data['action'] = $this->url->link('catalog/product/add', 'user_token=' . $this->session->data['user_token'] . $url . '&momday=1', true);
            } else {
                $data['action'] = $this->url->link('catalog/product/edit', 'user_token=' . $this->session->data['user_token'] . '&momday=1&product_id=' . $this->request->get['product_id'] . $url, true);
            }
            $data['cancel'] = $this->url->link('momday/momday_products', 'user_token=' . $this->session->data['user_token'] . $url, true);
        }
        /** * Momday Code Ends Here */
