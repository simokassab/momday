<?php
class ModelMomdayMomdayProducts extends Model {
    ...
    public function getProducts($data = array()) {
        ...
        AND p.product_id NOT IN (SELECT product_id FROM " . DB_PREFIX . "momday_customerseller_to_product WHERE product_id IS NOT NULL)
        AND p.product_id NOT IN (SELECT product_id FROM " . DB_PREFIX . "customerpartner_to_product WHERE product_id IS NOT NULL)";
